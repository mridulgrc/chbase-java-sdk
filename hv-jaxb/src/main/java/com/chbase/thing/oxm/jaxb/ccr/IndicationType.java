...
@XmlType(name = "IndicationType", propOrder = { "prnFlag", "description", "problem", "physiologicalParameter", "source",
		"internalCCRLink", "referenceID", "commentID", "signature", "indicationSequencePosition",
...
public class IndicationType {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the physiologicalParameter property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "parameterSequencePosition", "variableParameterModifier" })
	public static class PhysiologicalParameter extends MeasureType {

...
@XmlType(name = "FamilyHistoryType", propOrder = { "familyMember", "problem" })
public class FamilyHistoryType extends CCRCodedDataObjectType {
	 ...
	 * <CODE>set</CODE> method for the familyMember property.
	 * 
	 * <p>
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "healthStatus", "source", "internalCCRLink", "referenceID", "commentID",
			"signature" })
	public static class FamilyMember extends ActorReferenceType {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "type", "description", "episodes", "source", "internalCCRLink", "referenceID",
			"commentID", "signature" })

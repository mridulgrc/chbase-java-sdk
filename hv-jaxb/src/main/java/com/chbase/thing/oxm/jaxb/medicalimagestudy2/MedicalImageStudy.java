...
package com.chbase.thing.oxm.jaxb.medicalimagestudy2;
...
@XmlType(name = "", propOrder = { "when", "patientName", "description", "series", "reason", "previewBlobName",
		"keyImages", "studyInstanceUid", "referringPhysician", "accessionNumber" })
...
public class MedicalImageStudy {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the keyImages property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 

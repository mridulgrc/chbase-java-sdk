...
@XmlType(name = "DateTimeType", propOrder = { "type", "exactDateTime", "age", "approximateDateTime", "dateTimeRange" })
@XmlSeeAlso({ com.chbase.thing.oxm.jaxb.ccr.Direction.AdministrationTiming.class })
public class DateTimeType {
	 ...
	 * <CODE>set</CODE> method for the dateTimeRange property.
	 * 
	 * <p>
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "beginRange", "endRange" })
	public static class DateTimeRange {
		 ...
		 * 
		 * @return possible object is {@link DateTimeType.DateTimeRange.EndRange
		 *         }
		 * 
		 */
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "exactDateTime", "age", "approximateDateTime" })

...
@XmlType(name = "CCRCodedDataObjectType", propOrder = { "ccrDataObjectID", "dateTime", "iDs", "type", "description",
		"status", "source", "internalCCRLink", "referenceID", "commentID", "signature" })
@XmlSeeAlso({ StructuredProductType.class, EncounterType.class, FamilyHistoryType.class, PlanType.class, TestType.class,
		ProblemType.class, EpisodeType.class, AuthorizationType.class, SocialHistoryType.class, InsuranceType.class,
		AlertType.class, OrderRxHistoryType.class, ResultType.class, FunctionType.class, InterventionType.class })
public class CCRCodedDataObjectType {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "signatureID" })

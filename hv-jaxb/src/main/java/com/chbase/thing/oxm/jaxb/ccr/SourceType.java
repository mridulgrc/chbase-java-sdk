...
@XmlType(name = "SourceType", propOrder = { "description", "actor", "dateTime", "referenceID", "commentID" })
@XmlSeeAlso({ com.chbase.thing.oxm.jaxb.ccr.InternalCCRLink.Source.class })

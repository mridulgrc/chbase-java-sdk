...
@XmlType(name = "DoseCalculationType", propOrder = { "dose", "variable", "calculationEquation" })
@XmlSeeAlso({ com.chbase.thing.oxm.jaxb.ccr.Direction.DoseCalculation.class,
		com.chbase.thing.oxm.jaxb.ccr.Direction.DoseRestriction.class })
public class DoseCalculationType {
	 ...
	 * 
	 * @return possible object is {@link DoseCalculationType.CalculationEquation
	 *         }
	 * 
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "variableIdentifier", "variableSequencePosition", "variableModifier" })
	public static class Variable extends MeasureType {

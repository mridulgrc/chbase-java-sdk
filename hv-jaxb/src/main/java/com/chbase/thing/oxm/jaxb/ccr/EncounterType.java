...
@XmlType(name = "EncounterType", propOrder = { "locations", "practitioners", "frequency", "interval", "duration",
		"indications", "instructions", "consent" })
@XmlSeeAlso({ GoalType.class })
public class EncounterType extends CCRCodedDataObjectType {
